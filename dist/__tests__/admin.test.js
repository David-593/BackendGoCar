...
beforeAll(async () => {
    await (0, supertest_1.default)(app_1.default).post('/api/auth/register').send(mockAdmin);
    await (0, supertest_1.default)(app_1.default).post('/api/auth/register').send(mockUser);
